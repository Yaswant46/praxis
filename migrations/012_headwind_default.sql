-- =====================================================================
--  012 · Borrowed People — headwind default 3500
--
--  bp_create_session previously seeded bp_headwind at 6000, which needs
--  4-of-5 objectives "exceeded" to clear the ₹14,200 floor — too hard for
--  a first cohort. 3500 lets solid play (2 exceeded + 3 delivered) clear
--  it. Existing sessions are untouched; the facilitator can still override
--  per session. Only bp_create_session changes; it is reproduced in full
--  from supabase/borrowed_schema.sql.
--
